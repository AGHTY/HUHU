<?php
    ...
    if (mysqli_num_rows(mysql_query("SELECT username FROM member WHERE username='$username'")) > 0){
    ...
    if ($addmember)
        ...
        echo "Có lỗi xảy ra trong quá trình đăng ký. <a href='demo.php'>Thử lại</a>";
?>
